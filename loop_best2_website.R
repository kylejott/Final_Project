...
ggsave("/Users/Kyle/Dropbox/!Fall_2014/Collab_Data/Final_Project/Figures/binplot_web.png")
...
ggsave("/Users/Kyle/Dropbox/!Fall_2014/Collab_Data/Final_Project/Figures/shareplot_web.png")
...
ggsave("/Users/Kyle/Dropbox/!Fall_2014/Collab_Data/Final_Project/Figures/avetaxcount_web.png")


# plotting income against tax rate
# plot of lower bound income ranges
qplot(ratio, total_inc, data=clean, ylab  = 'Total Annual Income',
      xlab ='Average Tax Rate', ylim=c(150000,1000000),
      main = "Average Tax Rate Against Annual Total Income up to 1,000,000 euros") + theme_bw(base_size = 13)
ggsave("/Users/Kyle/Dropbox/!Fall_2014/Collab_Data/Final_Project/Figures/ratio_income_web1.png")

#plot of midding range incomes
qplot(ratio, total_inc, data=clean, ylab  = 'Total Annual Income',
      xlab ='Average Tax Rate', ylim=c(1000000,5000000),
      main = "Average Tax Rate Against Annual Total Income from 1 mil. to 5 mil. euros") + theme_bw(base_size = 13)
ggsave("/Users/Kyle/Dropbox/!Fall_2014/Collab_Data/Final_Project/Figures/ratio_income_web2.png")

#plot of top incomes
qplot(ratio, total_inc, data=clean, ylab  = 'Total Annual Income',
      xlab ='Average Tax Rate', ylim=c(5000000, 175000000),
      main = "Average Tax Rate Against Annual Total Income from 5 mil. to 175 mil euros") + theme_bw(base_size = 13)
ggsave("/Users/Kyle/Dropbox/!Fall_2014/Collab_Data/Final_Project/Figures/ratio_income_web3.png")
