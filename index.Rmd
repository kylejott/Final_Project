...
library(lmtest)
library(plm)
#dataset created by authors and scraped from website as explained below
load("cleaned.RData")
...
The variables given by our scraped data are as follows: full name, total income (in euros), total taxes paid (in euros), average tax rate (in percent), and the tax year. Note that the lowest income observed is 150,002 euros while the highest is 170,127,542 euros. The following table provides a quick overview:
...
The first graph plots the average tax rate paid against an individual's total a annual taxable income.
The next plot looks at incomes between 1 million and 5 million euros.
The third plot looks at incomes greater than 5 million euros.
...
This plot shows how over time the amount in terms of share that the top income earners have paid in relation to the total amount of taxes contributed by Finnish nationals. As of 2013, the top 0.4% contribute 0.8% of all collected tax revenues. We hope this plot will evoke many thoughts of income equality and redistribtuion of tax income.  
...
Our final plot goes out to fans of statistics and serves as a nudge to continue reading [our research]((https://github.com/kylejott/Final_Project/blob/master/final_paper.pdf). It simply plots the distributions of logged taxable income across our five years. 
...
We are inspired by the work of top tax economists that has been spearheaded by Thomas Piketty who is behind the *World Top Income Database* which is found [here](http://topincomes.parisschoolofeconomics.eu/). We encourage you to take a look at this website if you are interested in the very limited amount (but very important) work underway on understanding behovoiral changes of top income earners.
